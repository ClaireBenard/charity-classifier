...
prep_text_rec <-
  ...
  step_tokenfilter(charitable_objects, max_tokens = 300) %>%  # performance improved when reducing from 1000 rf and mnr disagree
...
```{r}
write_csv(acc_per_cat, here::here("./data/acc_per_cat.csv"))
```
